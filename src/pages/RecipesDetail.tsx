...
// Interfaces for recipe details and deleted recipes
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-col text-gray-700 gap-2.5">
            {Array.from({ length: 4 }).map((_, index) => (
              <div key={index} className="w-[180px] rounded-2xl h-6 bg-gray-300 animate-pulse"></div>
            ))}
          </div>
        </div>
...
// Recipe content display component
  ...
  return (
    <div className="flex flex-col gap-8 md:max-w-3xl md:mx-auto p-4">
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="flex flex-col bg-blue-800 text-white p-6 rounded-2xl w-full md:w-1/2 shadow">
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <div className="relative group">
          ...
          <div className="absolute bottom-16 right-0 bg-white rounded-lg shadow-lg w-36 opacity-0 group-hover:opacity-100 transform scale-95 group-hover:scale-100 transition-all duration-200">
            <button onClick={() => navigate("edit")} className="block w-full text-left px-4 py-2 text-sm text-gray-800 hover:bg-blue-100 rounded-t-lg transition">
              Edit
            </button>
            <button 
